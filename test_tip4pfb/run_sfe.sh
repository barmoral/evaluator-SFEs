...
#SBATCH --gres=gpu
#SBATCH --job-name=sfe_tip4pfb_test
#SBATCH --output=slurm_codes/sfe_tip4pfb_test.log
...
echo "Test of CC(C)C with 1000 total molecules using tip4pfb water and sage 1.3.1"
