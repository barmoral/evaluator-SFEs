...
#SBATCH --gres=gpu
#SBATCH --job-name=sfe_tip3p_test
#SBATCH --output=slurm_codes/sfe_tip3p_test.log
...
echo "Test of CC(C)C with 1000 total molecules using tip3p water and sage 1.3.1"
