...
#SBATCH --gres=gpu
#SBATCH --job-name=sfe_gopal_test
#SBATCH --output=slurm_codes/sfe_gopal_test.%j.log
...
function convert_ff_to_v3 () {
    FF="/rc_scratch/bamo6610/evaluator-SFEs/test_gopal/$1"
    cp /rc_scratch/bamo6610/evaluator-SFEs/test_gopal/$1 $FF
...
echo "Test of CC(C)C with 1000 total molecules using gopal water and sage 1.3.1"
