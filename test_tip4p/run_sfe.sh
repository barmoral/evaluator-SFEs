...
#SBATCH --gres=gpu
#SBATCH --job-name=sfe_tip4p_test
#SBATCH --output=slurm_codes/sfe_tip4p_test.log
...
echo "Test of CC(C)C with 1000 total molecules using tip4p-ew water and sage 1.3.1"
